/*
    name: "神回复"
    cron: 45 0 9 * * *
    环境变量名: SHENHUIFU_LIST
    备注: 神回复（无需账号）
*/

const { installShim } = require('../_lib/airscriptShim');
installShim({
  taskName: 'shenhuifu', configKey: 'SHENHUIFU_LIST',
  pushHeader: '【神回复】', requiresAccount: false, line: 21
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "shenhuifu";
var pushHeader = "【神回复】";
