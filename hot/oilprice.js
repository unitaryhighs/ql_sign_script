...
installShim({
  taskName: 'oilprice', configKey: 'OILPRICE_LIST',
  pushHeader: '【今日油价】', requiresAccount: false, line: 21, extraFields: ['area']
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "oilprice";
var pushHeader = "【今日油价】";
...
// 格式化油价数据
function getOilPriceString(data) {
...
function execHandle(cookie, pos) {
    ...
    let area = Application.Range("D" + pos).Text
