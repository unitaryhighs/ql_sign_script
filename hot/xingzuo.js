/*
    ...
    cron: 45 0 9 * * *
    环境变量名: XINGZUO_LIST
    备注: 无需账号（D列填星座名称，如白羊座）
*/

const { installShim } = require('../_lib/airscriptShim');
installShim({
  taskName: 'xingzuo', configKey: 'XINGZUO_LIST',
  pushHeader: '【星座运势】', requiresAccount: false, line: 21, extraFields: ['input']
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "xingzuo";
var pushHeader = "【星座运势】";
