...
installShim({
  taskName: 'streamrank', configKey: 'STREAMRANK_LIST',
  pushHeader: '【Steam在线人数】', requiresAccount: false, line: 21, extraFields: ['input']
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "streamrank";
var pushHeader = "【Steam在线人数】";
...
// 格式化 Steam 统计数据
function formatSteamStats(data) {
    const stats = [
      '🎮 ' + data.name_cn,
...
function execHandle(cookie, pos) {
    ...
    let input = Application.Range("D" + pos).Text
