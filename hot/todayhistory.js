...
installShim({
  taskName: 'todayhistory', configKey: 'TODAYHISTORY_LIST',
  pushHeader: '【历史上的今天】', requiresAccount: false, line: 21
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "todayhistory";
var pushHeader = "【历史上的今天】";
...
function resultHandle(resp, pos){
    ...
    const getEventEmoji = (desc) => {
      ...
      const matched = Object.entries(emojiMap).find(([key]) => desc.includes(key));
