/*
    name: "什么值得买抽奖"
    cron: 45 0 15 * * *
    环境变量名: SMZDM_COOKIE_LIST
    环境变量值: 填写cookie
*/

const { installShim } = require('../_lib/airscriptShim');
installShim({
  taskName: 'smzdm', configKey: 'SMZDM_COOKIE_LIST',
  pushHeader: '【什么值得买抽奖】', primaryField: 'cookie',
  requiresAccount: true, line: 21
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "smzdm";
var pushHeader = "【什么值得买抽奖】";
...
function execHandle(cookie, pos) {
    ...
    var url = "https://zhiyou.smzdm.com/user/lottery/jsonp_draw?active_id=ljX8qVlEA7";
    headers = {
