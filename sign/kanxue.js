...
installShim({
  taskName: 'kanxue', configKey: 'KANXUE_COOKIE_LIST',
  pushHeader: '【看雪论坛】', primaryField: 'cookie',
  requiresAccount: true, line: 21
});

const logo = "ql_sign_script : https://github.com/unitaryhighs/ql_sign_script"
var sheetNameSubConfig = "kanxue";
var pushHeader = "【看雪论坛】";
...
function execHandle(cookie, pos) {
    ...
    var url = "https://bbs.kanxue.com/user-signin.htm";
    headers = {
    ...
    // 传对象而非 JSON.stringify(data)，避免 shim 双重编码
